...
<body>
    ...
    echo "<div style='font-weight: bold; font-size: 19vw; text-align: left; padding-left: 2.5vw; width: auto; position: absolute; right: 2.5vw; top: 50vw;' ><span id='current_temp'>$current_temp</span>° F</div>";
    ?>
    </div>
    ...
    <div id='bottom-cover'>
        ...
        echo "<img src='../weather_icons/$picture.png' id='logo' style='width: 20vw; position: relative; left: 40vw;' />";
    ...
    <div style='text-align: center; font-size: 3.5vw; font-weight: 300; padding-bottom: 5vw;'><img
            src='../weather_icons/Wind.png' class='small_icon' /> Wind: <span>$wind_today</span> mph</div>"
            ?>
        ...
        <img src='../weather_icons/$picture_forecast.png' class='weather_icon'/>
        <div>↑<span >$highest_temp_forecast</span>F; ↓<span>$lowest_temp_forecast</span>F</div>
        <div><img src='../weather_icons/Wind.png' class='wind_icon'/><span> $wind_forecast</span> mph</div>
    </div>";
        }
        ?>
    </div>
